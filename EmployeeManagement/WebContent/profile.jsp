...
%>
  <label>
    ...
    <input type="text" class="input" name="username" value="${profile.id}" required readonly>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  ...
  <label>
    ...
    <input type="text" class="input" name="username" value="${profile.username}" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  ...
  <label>
    ...
    <input type="email" class="input" name="email" value="${profile.email}" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  ...
  <label>
    ...
    <input type="text" class="input" name="role" value="${profile.role}" required readonly>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
    ...
    <input type="text" class="input" name="manager_name" value="${profile.manager_name}" required>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>

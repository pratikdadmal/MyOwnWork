...
public class StudentController {
	...
	@GetMapping(value="/studentbycity")
	public List<Student> findStudentbyCity(@RequestParam String city)
	{
		System.out.println("checked");
		List<Student> findcity = student_service_interface.findStudentbyCity(city);
		return findcity;
